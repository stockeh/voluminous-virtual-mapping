...
public class ClientEntryResponse implements Event{
  ...
  public ClientEntryResponse(int type, int mapSize, int sectorSize, String serverToConnect) {
    this.type = type;
  ...
  public ClientEntryResponse(byte[] bytes) {
